...
tools: Read, Bash(bun scripts/verify-release.ts:*), Bash(cosign:*), Bash(syft:*), Bash(mise x zig@0.16.0 -- zig:*), Bash(jj log:*), Bash(jj show:*), Bash(jj diff:*), Bash(jj status:*), Bash(jj op log:*), Bash(git log:*), Bash(git show:*), Bash(git diff:*), Bash(git status:*)
model: opus
---
